  ...
  naked_clothing.forEach((item, i) => {
    if (slave.clothing == item && (s >= 40 || h >= 40)) {
      ...
      change_these.forEach((item, i) => {
        slave.scales.find(function(stat) {if(stat.name == item) return stat}).level += 5
      ...
      change_these.forEach((item, i) => {
        slave.kinks.find(function(stat) {if(stat.name == item) return stat}).level += 2
      });
...
function domClothing(slave) {
  ...
  dom_clothing.forEach((item, i) => {
    if (slave.clothing == item && d >= 40) {
      ...
      slave.scales.find(function(stat) {if(stat.name == "Libido") return stat}).level += 5
      ...
      slave.kinks.find(function(stat) {if(stat.name == "Dominating") return stat}).level += 1
      slave.scales.find(function(stat) {if(stat.name == "Libido") return stat}).level += 1
      phrases.push(slave.name + " obediently wore " + slave.clothing + " this week")
    }
  });
...
function liveryClothing(slave) {
  ...
  var loyalty = slave.scales.find(function(stat) {if(stat.name == "Loyalty") return stat}).level
  if (slave.clothing == livery_clothing[0]) {
    if (love >= 40 || loyalty >= 40) {
      slave.scales.find(function(stat) {if(stat.name == "Love") return stat}).level += 5
      slave.scales.find(function(stat) {if(stat.name == "Loyalty") return stat}).level += 5
      slave.scales.find(function(stat) {if(stat.name == "Happiness") return stat}).level += 2
      ...
      slave.scales.find(function(stat) {if(stat.name == "Love") return stat}).level += 2
      slave.scales.find(function(stat) {if(stat.name == "Loyalty") return stat}).level += 2
...
function punishingClothing(slave) {
  ...
  if (slave.responds_to == "severity") {
    slave.scales.find(function(stat) {if(stat.name == "Obedience") return stat}).level += 5
    slave.scales.find(function(stat) {if(stat.name == "Loyalty") return stat}).level += 2
    ...
    change_these.forEach((item, i) => {
      slave.scales.find(function(stat) {if(stat.name == item) return stat}).level -= 2
    });
